...
namespace Reader
{
    ...
    {   
        ...
        string[] Ellipse (double radiuos1, double radiuos2, double centerx, double centery)
        {
        ...
        string[] Square(double side, double centerx, double centery)
        {
        ...
        string[] Circule(double radius, double centerx, double centery)
        {                     
